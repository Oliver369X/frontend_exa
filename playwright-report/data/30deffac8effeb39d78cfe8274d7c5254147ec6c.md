...
- Name: Project CRUD E2E >> should create, display and delete a project [es]
- Location: C:\Users\OLIVER\OLIVER\sw1\sw_exa\frontend\tests\e2e\project-crud.spec.ts:20:9
...
Call log:
  - waiting for getByLabel(/password|contraseña/i)
    ...
    at C:\Users\OLIVER\OLIVER\sw1\sw_exa\frontend\tests\e2e\project-crud.spec.ts:18:7
```

...
- Name: Dashboard E2E >> should display dashboard and sidebar correctly [en]
- Location: C:\Users\OLIVER\OLIVER\sw1\sw_exa\frontend\tests\e2e\dashboard.spec.ts:16:9
...
Call log:
  - waiting for getByLabel(/password|contraseña/i)
    ...
    at C:\Users\OLIVER\OLIVER\sw1\sw_exa\frontend\tests\e2e\dashboard.spec.ts:14:7
```

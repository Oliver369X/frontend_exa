...
- Name: Project Form Validation E2E >> no debe crear proyecto sin nombre [es]
- Location: C:\Users\OLIVER\OLIVER\sw1\sw_exa\frontend\tests\e2e\project-validation.spec.ts:16:9
...
Call log:
  - waiting for getByLabel(/password|contraseña/i)
    ...
    at C:\Users\OLIVER\OLIVER\sw1\sw_exa\frontend\tests\e2e\project-validation.spec.ts:14:7
```
...
- main:
  ...
  - textbox "Email or username": val-e2e@example.com
  - text: Password
  - textbox "Password"

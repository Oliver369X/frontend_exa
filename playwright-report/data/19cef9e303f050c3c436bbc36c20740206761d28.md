...
- Name: Auth E2E (login only) >> should login successfully [es]
- Location: C:\Users\OLIVER\OLIVER\sw1\sw_exa\frontend\tests\e2e\auth-flow.spec.ts:12:9
...
Call log:
  - waiting for getByLabel(/password|contraseña/i)
    ...
    at loginOnly (C:\Users\OLIVER\OLIVER\sw1\sw_exa\frontend\tests\e2e\utils\e2e-auth.ts:30:49)
    at C:\Users\OLIVER\OLIVER\sw1\sw_exa\frontend\tests\e2e\auth-flow.spec.ts:14:9
```
...
- main:
  ...
  - textbox "Email or username": user@example.com
  - text: Password
  - textbox "Password"
